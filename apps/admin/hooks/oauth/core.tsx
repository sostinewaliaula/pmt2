...
import { KeyRound, Mails, Server } from "lucide-react";
// types
import type {
...
export const getCoreAuthenticationModesMap: (
  ...
  ldap: {
    ...
    description: "Allow members to log in with their LDAP or Active Directory credentials.",
    icon: <Server className="h-6 w-6 p-0.5 text-tertiary" />,
